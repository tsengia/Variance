...
def load_api(rest_api):
    ...
    api.muscles.muscle_endpoint.attach(rest_api)
    api.muscles.muscle_groups_endpoint.attach(rest_api)
    ...
    api.consumables.consumable_endpoint.attach(rest_api)
    api.recipes.recipe_endpoint.attach(rest_api)
